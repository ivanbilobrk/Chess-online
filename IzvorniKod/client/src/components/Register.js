            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={5}>
                <TextField
                  ...
                  helperText = {ErrorInput(nameCount, validName, nameFocus)? 'Ime ne smije biti prazno':''}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={5}>
                <TextField
                  ...
                  error={ErrorInput(surnameCount, validsurname, surnameFocus)}
              ...
              <Grid item xs={12} sm={11}>
                <TextField
                 inputProps={{ maxLength: 24 }}
                  ...
                  helperText = {ErrorInput(usernameCount, validUser, userFocus) ?'Username mora biti između 4-24 znaka te'
              ...
              <Grid item xs={12} sm={11}>
                <TextField
                  ...
                  helperText = {ErrorInput(emailCount, validEmail, emailFocus) ?'Unesite ispravan e-mail.':''}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={11}>
                <TextField
                  ...
                  helperText = {ErrorInput(passwordCount, validPwd, pwdFocus) ?'Lozinka mora biti između 8 i 24 znaka te se sastoji od: '
